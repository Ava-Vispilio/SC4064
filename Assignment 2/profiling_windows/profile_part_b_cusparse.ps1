...
& ncu --set speedOfLight --section LaunchStats --target-processes application-only --launch-skip 20 --launch-count 10 --force-overwrite --export part_b_cusparse_profile .\part_b_wave_profile_cusparse.exe 2>&1 | Tee-Object -FilePath part_b_cusparse_profile_ncu_final.log
