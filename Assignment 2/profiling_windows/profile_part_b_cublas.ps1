# Part B cuBLAS profiling: compile, plain run, ncu smoke, ncu export.
...
Write-Host "[3/6] Compiling Part B cuBLAS profiling binary"
& nvcc -O3 -lineinfo -std=c++17 -DPART_B_PROFILE_MODE=2 -o part_b_wave_profile_cublas.exe part_b_wave.cu -lcusparse -lcublas
Get-Item part_b_wave_profile_cublas.exe

Write-Host "[4/6] Plain execution sanity check"
& .\part_b_wave_profile_cublas.exe | Tee-Object -FilePath part_b_cublas_profile_plain.log
